...
const categories = [
  ...
  { name: 'Dashboard Pemupukan', href: 'https://gis.ptpn4.or.id/portal/apps/opsdashboard/index.html#/cb7f9ffbfa9d4985bf3dd4915a556027', sub: 'Monitoring Realisasi Pemupukan', icon: GiFertilizerBag },
